...
function Rolldate(config){
  ...
  if(config.value){
      ...
      let str = curVal.replace(/-/g,'/').replace(/[^\d/:\s]/g,''),
          date = new Date(str);
                    ...
                    if (f != 'YYYY'){
                        if (location.y * 1 < endDomLocation * -1){
                            ...
                            if (f == 'MM'){
                              ...
                              console.log('当前时间')
                              console.log(_this.getscrollDay(_this.scroll['YYYY']));
                              console.log(_this.getscrollDay(_this.scroll['MM']))
                              console.log(_this.bissextile(_this.getscrollDay(_this.scroll['YYYY']), _this.getscrollDay(_this.scroll['MM'])) * 1);
                              var num =  _this.bissextile(_this.getscrollDay(_this.scroll['YYYY']), _this.getscrollDay(_this.scroll['MM'])) * 1  + 2;
                              that.wheelTo(num);
                                // that.wheelTo(_this.bissextile(date.getFullYear(),date.getMonth()) * 1  + 2);
                                console.log(num*1);
                            }else if(f == 'hh'){
                                that.wheelTo(26);
                            }else if(f == 'mm'){
